...
@Autonomous(name = "Six Ball Nats Blue", group = "Autonomous")
@Configurable
public class SixBall_Nats_Blue extends OpMode {
    ...
    // Configurable shooting heading (in degrees) - mirrored for blue
